...
function TagsPage() {
	...
	async function handleRenameTag(oldTag: string) {
		...
		// Filter snippets that have the old tag
		const snippetsToUpdate = result.data.items.filter((snippet) => snippet.tags.includes(oldTag))
	...
	async function handleDeleteTag(tag: string) {
		...
		// Filter snippets that have the tag
		const snippetsToUpdate = result.data.items.filter((snippet) => snippet.tags.includes(tag))
